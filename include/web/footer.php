       ...
       <div class="col-md-3 col-sm-6">
        <div class="aa-footer-widget">
         ...
         <ul class="aa-footer-nav">
          ...
          <li><a href="<?php echo DOMAIN; ?>/web/store">Utility Kart</a></li>
         </ul>
        </div>
       </div>
       <div class="col-md-3 col-sm-6">
        <div class="aa-footer-widget">
         <div class="aa-footer-widget">
          ...
          <ul class="aa-footer-nav">
           ...
           <?php } else { ?>
            <li><a href="<?php echo DOMAIN; ?>/auth/web/login">Login into Account</a></li>
           <?php } ?>
           <li><a href="<?php echo DOMAIN; ?>/web/support">Have an Enquiry</a></li>
