...
<body onload="doConvert()" style="color: #505050d1;margin:auto;font-family:-apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Oxygen, Ubuntu, Cantarell, 'Open Sans', 'Helvetica Neue', sans-serif !important;">

	<section style="border-style:groove; border-width:thin;margin: auto; width: 700px;border: 1px solid green;padding: 3px;height:650px;">
		<center>
			<img src="<?php echo $MAIN_LOGO; ?>" style="width: 100px;">
			<h5 style="margin-bottom: 0px;margin-top: -6px;"><?php echo APP_NAME; ?></h5>
			<p style="font-size: 11px;margin-bottom: 0px;margin-top: -2px;"><b>Office Address</b> <?php echo SECURE(PRIMARY_ADDRESS, "d"); ?></p>
			<p style="font-size: 11px;margin-bottom: 0px;margin-top: -2px;">
				<b>Phone:</b> <?php echo PRIMARY_PHONE; ?>
				<b>Email:</b> <?php echo PRIMARY_EMAIL; ?>
				<b>Website:</b> <?php echo DOMAIN; ?>
			</p>
			<p style="font-size: 11px;margin-bottom: 0px;margin-top: -2px;"><b>GST No:</b> <?php echo PRIMARY_GST; ?></p>
			<hr style="margin-bottom: 2px;margin-top: 2px;background-color: #80808024;color: aquamarine;height: 1px;border: none;">
			<p style="font-size: 12px;margin-bottom: 0px;margin-top: -2px;"><b>INVOICE</b></p>
		</center>
		<div style="display: flex;justify-content: space-between;">
			<p style="font-size: 11px;margin-bottom: 0px;margin-top: -2px;width: 40%;"><b>Shipping Address</b><br>
				<?php echo SECURE(FETCH("SELECT * FROM orders where OrderId='$Orderid'", "OrderShippingAddress"), "d"); ?>
			</p>
			<p style="font-size: 11px;margin-bottom: 0px;margin-top: -2px;width: 40%;"><b>Billing Address</b><br>
				<?php echo SECURE(FETCH("SELECT * FROM orders where OrderId='$Orderid'", "OrderBillingAddress"), "d"); ?>
			</p>
			<p style="font-size: 11px;margin-bottom: 0px;margin-top: -2px;width: 20%;">
		...
		<p style="font-size: 12px;margin-bottom: 0px;margin-top: 10px;text-align:center;text-transform:uppercase;"><b>ITEM DETAILS</b></p>
				...
				while ($fetch = mysqli_fetch_array($fetchItems)) {
					...
					<tr style="box-shadow: 0px 1px 0px 0px #8080800f;">
						...
						<td style="font-size: 11px;">
							<?php echo $fetch['OrderProductName']; ?><br>
							<span>HSN: <?php echo $fetch['ProductRefernceCodes']; ?> | <?php echo $fetch['OrderProductBrandName']; ?> | <?php echo $fetch['OrderProductWeight']; ?></span>
						</td>
						<td align="center">
						...
						<td align="right">
							<b>Rs.<?php echo $fetch['OrderProductSellAmount']; ?></b>
						</td>
					<?php } ?>
			</tbody>
		</table>
