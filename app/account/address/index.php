  ...
  <section class="container">
   <div class="row">
    <div class="col-md-6 col-lg-6 col-sm-6 col-12">
     <h3><i class="fa fa-user text-color"></i> My Account <i class="fa fa-angle-double-right"></i> My Address</h3>
    ...
    <div class="col-md-6">
     <a href="<?php echo DOMAIN; ?>/web/account/orders">
      <div class="account-section">
       ...
       <div class="details">
        <h5>Item Name</h5>
        <span class="fs-14 text-grey">#ID9382798789</span> |
        <span class="fs-14 text-grey"> <i class="fa fa-calendar"></i> 23 Nov 2021</span>
        <p>
         <span class="order-status text-danger"><i class="fa fa-refresh fa-spin"></i> Order Placed</span>
         <span class="order-price">Rs.0000</span>
        </p>
       </div>
      </div>
     </a>
