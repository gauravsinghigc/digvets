...
//request variables
$Requested_ProductId = Req_Data("view", "GET", true, "dec");
        ...
        <div class="col-lg-8 col-md-8 col-sm-6 col-12">
          <div class="item-brief">
            ...
            <ul class="inline-list-view">
              ...
              <li><b>Weight <i class="fa fa-angle-double-right"></i></b> <?php echo GET_DATA("ProductWeight"); ?></li>
            </ul>
            <p>
              <span class="app-price-2">Rs.<?php echo GET_DATA("ProductSellPrice"); ?></span>
              <span class="type"><strike>Rs.<?php echo GET_DATA("ProductMrpPrice"); ?></strike></span>
            </p>
            ...
            <form action="../../../controller/ordercontroller.php" method="POST" class="add-to-cart-options">
              ...
              <div class="row">
                <div class="col-lg-3 col-md-3 col-sm-3 col-4">
                  <select class="form-control fs-20 p-1r lh-1-10" name="qty" required="">
                    <?php
                ...
                <div class="col-lg-3 col-md-3 col-sm-3 col-4">
                  <button type="submit" name="AddtoCart" value="<?php echo $Requested_ProductId; ?>" class="btn btn-md btn-success">Add to Cart <i class="fa fa-shopping-cart"></i></button>
                </div>
              </div>
            </form>
            <hr>
