                ...
                <div class="col-md-12">
                  <div class="table-responsive">
                    <table class="table table-striped">
                      ...
                      <?php
                      $DB_DATA_FETCH = FetchConvertIntoArray("SELECT * FROM orders where OrderStatus='4' ORDER BY OrderId DESC", true);
                      if ($DB_DATA_FETCH == null) {
                        NoDataTableView("No Orders Found!", "8");
                      } else {
