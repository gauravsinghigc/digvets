          ...
          <div class="panel">
            <div class="panel-body">
              <div class="flex-s-b app-heading">
                ...
                <a href="#" onclick="Databar('Addcategories')" class="btn btn-primary btn-sm"><i class="fa fa-plus"></i> Add Categories</a>
              </div>
                ...
                <div class="col-md-12">
                  <table class="table table-striped">
                    ...
                    while ($FetchProCategories = mysqli_fetch_array($SqlProCategories)) {
                      ...
                      <tr>
                        <td><?php echo $ProCategoriesId; ?></td>
                        <td>
      ...
      <div class="add-data-form">
        <form class="data-form" action="../../controller/productscontroller.php" method="POST" enctype="multipart/form-data">
          ...
          <div class="main-data">
            ...
            <div class="main-data-footer">
              <button type="Submit" onclick="form.submit()" value="null" name="CreateProductCategories" class="btn btn-md app-btn">Create Sub Categories</button>
