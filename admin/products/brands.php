          ...
          <div class="panel">
            <div class="panel-body">
              <div class="flex-s-b app-heading">
                <h4 class="m-b-0 m-t-5">All Brands</h4>
                  ...
                  <table class="table table-striped">
                    ...
                    while ($fetchpro_brands = mysqli_fetch_array($SQLpro_brands)) {
                      ...
                      <tr>
                        ...
                        <td>
                          <a href="edit-brand.php?viewid=<?php echo SECURE($ProBrandId, "e"); ?>" class="text-primary">
                          ...
                          <form class="data-form" action="../../controller/productscontroller.php" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="main-data">
                              <div class="main-data-header app-bg">
                                <div class="flex-s-b app-heading">
                                  <h4 class="mt-0 mb-0">Update Brand Details</h4>
                              ...
                              <div class="main-data-footer">
                                <button type="Submit" name="UpdateProductbrands" value="<?php echo SECURE($ProBrandId, 'e'); ?>" class="btn btn-md app-btn">Update Brands</button>
      ...
      <div class="add-data-form">
        <form class="data-form" action="../../controller/productscontroller.php" method="POST" enctype="multipart/form-data">
          ...
          <div class="main-data">
            ...
            <div class="main-data-footer">
              <button type="Submit" onclick="form.submit()" value="null" name="CreateProductbrands" class="btn btn-md app-btn">Create Brands</button>
