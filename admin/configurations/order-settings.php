                        ...
                        <div class="col-lg-4 col-md-4 col-sm-4 col-12">
                           <div class="shadow-lg br10 p-2">
                              ...
                              <form class="form row" action="../../controller/configcontroller.php" method="POST">
                                 ...
                                 <div class="col-md-12">
                                    <button name="UpdateDeliveryCharges" value="<?php echo SECURE("1", "e"); ?>" class="app-bg btn btn-md">Update Charges</button>
                                 </div>
                              </form>
                           </div>
                        </div>
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-4 col-12">
                           <div class="shadow-lg br10 p-2">
                              ...
                              <form class="form row" action="../../controller/configcontroller.php" method="POST">
                                 ...
                                 <div class="col-md-12">
                                    <button name="UpdateMaxOrderQTY" value="<?php echo SECURE("1", "e"); ?>" class="app-bg btn btn-md">Update Orders</button>
                                 </div>
                              </form>
                           </div>
                        </div>
