                    ...
                    if ($FetchSliders != null) {
                      ...
                      foreach ($FetchSliders as $data) {
                        ...
                        <tr>
                          ...
                          <td>
                            <img src="<?php echo STORAGE_URL; ?>/sliders/<?php echo $data->SliderType; ?>/img/<?php echo $data->SliderImage; ?>" title="<?php echo $data->SliderName; ?>" alt="<?php echo $data->SliderName; ?>" class="w-100 pro-img">
                          </td>
                          <td>
