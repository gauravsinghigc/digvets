                        ...
                        <h3 class="m-t-10">Page Name : <?php echo $Fields->PageName; ?></h4>
                          ...
                          <form class="m-t-5" action="../../../controller/pagecontroller.php" method="POST">
                            ...
                            <div class="form-group">
                              ...
                              <textarea name="PageContent" class="form-control" required="" id="editor" rows="30" style="height:max-content !important;"><?php echo SECURE($Fields->PageContent, 'd'); ?></textarea>
                            </div>
                            <div class="m-b-0">
                              <button type="submit" name="UpdatePageContent" class="btn btn-md app-bg">Update</button>
                            </div>
                          </form>
                      </div>
                    </div>
