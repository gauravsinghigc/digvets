                    ...
                    <div class="row">
                      ...
                      <div class="form-group col-lg-4 col-md-4 col-sm-6 col-12">
                        ...
                        <select name="SliderLocations" class="form-control-2" required="">
                          ...
                          <?php InputOptions(["HomePageWebsite", "HomePageApp"]); ?>
                        </select>
                      </div>
                      <div class="form-group col-lg-4 col-md-4 col-sm-6 col-12">
                        ...
                        <select name="SliderOpenAt" class="form-control-2" required="">
                          ...
                          <?php InputOptions(["Same Page", "New Tab"]); ?>
                        </select>
                      </div>
                      <div class="form-group col-lg-4 col-md-4 col-sm-6 col-12">
                      ...
                      <div class="form-group col-lg-4 col-md-4 col-ms-4 col-12">
                        ...
                        <img src="<?php echo STORAGE_URL; ?>/sliders/<?php echo GET_DATA('SliderType'); ?>/img/<?php echo GET_DATA('SliderImage'); ?>" class="imgrpreview m-t-10">
                      </div>
                      <div class="col-md-12">
